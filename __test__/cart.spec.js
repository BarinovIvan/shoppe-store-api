...
describe('testing cart API', () => {
  it('get all carts', async () => {
    const response = await supertest(app).set('Cookie', 'authorization=amigo').get('/carts');
  ...
  it('get a single cart', async () => {
    const response = await supertest(app).set('Cookie', 'authorization=amigo').get('/carts/2');
    expect(response.status).toBe(200);
    console.log(response.body);
    expect(response.body).not.toEqual({});
  ...
  it('get carts in a date range and limit and sort', async () => {
    const response = await supertest(app)
      ...
      .get('/carts?limit=2&sort=desc&startdate=2019-12-10&enddate=2020-10-10');
    expect(response.status).toBe(200);
  ...
  it('get carts in for user in date range', async () => {
    const response = await supertest(app)
      .set('Cookie', 'authorization=amigo')
      .get('/carts/user/1?startdate=2019-12-10&enddate=2020-10-10');
    expect(response.status).toBe(200);
  ...
  it('get carts in for user without start date', async () => {
    const response = await supertest(app)
      .set('Cookie', 'authorization=amigo')
      .get('/carts/user/1?enddate=2020-10-10');
    expect(response.status).toBe(200);
  ...
  it('get carts in for user without end date', async () => {
    const response = await supertest(app)
      .set('Cookie', 'authorization=amigo')
      .get('/carts/user/1?startdate=2019-12-10');
    expect(response.status).toBe(200);
  ...
  it('get carts in for user', async () => {
    const response = await supertest(app).set('Cookie', 'authorization=amigo').get('/carts/user/1');
    expect(response.status).toBe(200);
  ...
  it('delete a cart', async () => {
    const response = await supertest(app).set('Cookie', 'authorization=amigo').delete('/carts/2');
    expect(response.status).toBe(200);
    console.log(response.body);
    expect(response.body).toHaveProperty('id');
  });
